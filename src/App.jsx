    ...
    <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div className="animate__animated animate__fadeInUp animate__delay-3s">
          ...
          <h1 className="text-5xl/tight font-bold mb-6">Hai, Saya Alif Ramadhani</h1>
          <p className="text-base/loose mb-6 opacity-50">Saya adalah siswa SMKN46 dari Jurusan Rekayasa Perangkat Lunak, saya memiliki ketertarikan terhadap dunia programming dan desainer, terutama pada pembuatan website, tidak hanya membuat website saya juga memiliki beberapa projek character 3d basic dan lainnya</p>
        ...
        <img src={DataImage.HeroImage} alt="Hero Image" className="w-[500-px] md:ml-auto rounded-xl animate__animated animate__fadeInUp animate__delay-4s" loading="lazy" />
      </div>
      ...
      <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
        ...
        <form action="https://formsubmit.co/alif.ramadhani2007@gmail.com" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
